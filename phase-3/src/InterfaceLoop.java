...
public class InterfaceLoop {
    ...
    /**
     * Method to appoint a pilot to lead a drone
     * @param service_name The Delivery Service that owes the drone
     * @param user_name The username of the pilot going to lead the drone
     * @param drone_tag The tage of the drone that is going to be led by the pilot
     */
        ...
        if (movedDrone instanceof FollowerDrone) {
            ...
            if (distance > leadDrone.getFuel()) {
                ...
                if (destinationLocation.getSpacesLeft() < leadDrone.getSwarm().size() + 1) {
                    ...
                    //confirmed successful trips is based on number of trips, not drones
